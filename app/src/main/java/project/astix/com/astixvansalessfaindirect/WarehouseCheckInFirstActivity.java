...
public class WarehouseCheckInFirstActivity extends BaseActivity implements LocationListener,GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener,OnMapReadyCallback
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        refreshCount=0;
        helperDb=new PRJDatabase(WarehouseCheckInFirstActivity.this);
...
*/
    ...
    public void locationRetrievingAndDistanceCalculating()
    {
        ...
        pDialog2STANDBY = ProgressDialog.show(WarehouseCheckInFirstActivity.this, getText(R.string.genTermPleaseWaitNew), getText(R.string.rtrvng_loc), true);
        ...
        if (isGooglePlayServicesAvailable()) {
            ...
            mGoogleApiClient = new GoogleApiClient.Builder(WarehouseCheckInFirstActivity.this)
                    .addApi(LocationServices.API)
                    .addConnectionCallbacks(WarehouseCheckInFirstActivity.this)
                    .addOnConnectionFailedListener(WarehouseCheckInFirstActivity.this)
                    .build();
            mGoogleApiClient.connect();
        }
        //startService(new Intent(DynamicActivity.this, AppLocationService.class));
        startService(new Intent(WarehouseCheckInFirstActivity.this, AppLocationService.class));
