...
public class StoreAndSKUWiseSummaryReport_ByTab extends BaseActivity
{
	...
	Fragment fragmentOneTab = new StoreAndSKUWiseFragmentOneTab();
	Fragment fragmentTwoTab = new StoreAndSKUWiseFragmentTwoTab();
	Fragment fragmentThreeTab = new StoreAndSKUWiseFragmentThreeTab();
	...
	try
	{
        ...
        actionBar.setTitle(getResources().getString(R.string.txtStoreSKUSummary));
	...
	public boolean onOptionsItemSelected(MenuItem item) 
	{
	    switch (item.getItemId()) 
	    {
	        case android.R.id.home:
	        	...
	        	Intent ide=new Intent(StoreAndSKUWiseSummaryReport_ByTab.this,DetailReportSummaryActivity.class);
